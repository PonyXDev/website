  ...
  return (
    <>
      <div className="py-20">
        ...
        <p className="text-xl text-white/50 font-normal text-center mb-5">The page I created to introduce you to the projects I've been involved in and supported.</p>
